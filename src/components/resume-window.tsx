        ...
        <Tooltip>
            <TooltipTrigger>
                <DrawerTrigger asChild>
                    <div className="flex items-center cursor-pointer border-spacing-0 rounded-2xl underline py-2 px-1 gap-1 relative right-2">Read My Resume<img className="size-6" src="popup.png"></img></div>
                </DrawerTrigger>
            </TooltipTrigger>
  ...
  return (
      ...
      <Drawer open={open} onOpenChange={setOpen}>
        <Tooltip>
            <TooltipTrigger>
                <DrawerTrigger asChild>
                    <div className="cursor-pointer scale-140 border-0 rounded-xl underline px-4 py-1 flex gap-2 items-center">Read My Resume <img className="size-6" src="popup.png"></img></div>
                </DrawerTrigger>
            </TooltipTrigger>
            <TooltipContent className=" bg-black text-white h-10 p-3 flex rounded-2xl items-center">
                Click to Open PDF
