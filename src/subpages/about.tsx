        ...
        <div className="scroll-mt-[118px]">
            <div className="border-0 border-red-500 flex items-center justify-around grid-cols-3 h-96 ">
                ...
                <div className="grid grid-rows-10 w-90/100 lg:w-2/4 border-3 h-full bg-gray-50/80">
                    <div className="row-span-1 border-3 border-yellow-400 text-blue-500/88 grid lg:text-2xl font-semibold  place-items-center justify-items-center bg-gray-100/30">About Me</div>
                    <div style={{position: 'relative',overflow: 'hidden'}} className="row-span-9 overflow-auto border-0 w-full lg:px-2 justify-center lg:text-xl/10 lg:font-semibold">
                        <div ref={divRef} className="h-full select-none scrollbar scroll-smooth overflow-y-scroll scrollbar-thumb-green-700/60
                        hover:scrollbar-thumb-green-700/60 scrollbar-track-sky-500/15">
                            <Content/>                        
                        </div>
