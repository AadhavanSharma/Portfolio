...
const InsideWorkExp = ()=>{
    return (
        <div className="border-0 text-white flex items-center justify-around grid-cols-3 h-128">
            ...
            <div className="w-5/6 md:w-2/4 border-0 border-red-700 h-full bg-gray-0/60 grid grid-rows-110">
                <div style = {{fontFamily:"English Towne"}} className="text-gray-300 row-span-10 border-0 flex items-center justify-center text-4xl">Work Experience</div>
                <div className="border-0 m-1 border-green-500 grid grid-cols-100 row-span-50">
                    ...
                    <div className=" col-span-90 border-0 grid grid-rows-10">
                        <div className="row-span-3 border-1 rounded-2xl p-2 font-serif h-fit bg-gray-0/60">
                ...
                <div className="border-0 m-1 border-green-500 grid grid-cols-100 row-span-50">
                    ...
                    <div className=" col-span-90 border-0 grid grid-rows-10">
                        <div className="row-span-3 rounded-2xl border-1 p-2 font-serif h-fit bg-gray-0/60">
            ...
            <div className="w-1/12 md:w-1/4 border-0 h-full bg-gray-0/60"></div>
        </div>
    )
}
